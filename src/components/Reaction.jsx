...
const testimonials = [
  ...
  },
  {
    id: 4,
    text:
      "4.Create contracts, agreements & forms in seconds using advanced AI technology",
    rating: 5,
  },
  {
    id: 5,
    text:
      "5.Create contracts, agreements & forms in seconds using advanced AI technology",
    rating: 5,
  },
  {
    id: 6,
  ...
  return (
    <div className="relative w-full flex flex-col items-center py-12">
      ...
      <div className="relative w-full max-w-6xl flex items-center">
        {/* Left Arrow */}
        <button className="swiper-button-prev-custom absolute z-10 sm:left-[-30px] lg:left-[-60px] bg-[#1e3a5f] text-white p-4 rounded-full shadow-md hover:bg-[#112233] transition">
        ...
        >
          {testimonials.map((testimonial) => (
            <SwiperSlide key={testimonial.id}>
              <div className="bg-white p-6 m-3 rounded-3xl shadow-lg flex flex-col items-center text-center transition-all duration-500 hover:scale-105 ">
                {/* User Icon with Glow */}
        ...
        {/* Right Arrow */}
        <button className="swiper-button-next-custom absolute z-10 sm:right-[-30px] lg:right-[-60px] bg-[#1e3a5f] text-white p-4 rounded-full shadow-md hover:bg-[#112233] transition">
